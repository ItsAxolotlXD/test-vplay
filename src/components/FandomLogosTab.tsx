        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 items-stretch">
            ...
            <div className="lg:col-span-5 relative flex items-center">
              ...
              />
              <img src="https://static.wikia.nocookie.net/ep-deo/images/a/a4/MagnifyingGlass.png/revision/latest?cb=20260730091531" className="w-4 h-4 absolute right-4 pointer-events-none object-contain" referrerPolicy="no-referrer" alt="Search" />
            </div>
