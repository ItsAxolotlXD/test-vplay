          ...
          {!clearDisplay && (
            <div className={`absolute right-3.5 z-30 flex flex-col items-center gap-4 pointer-events-auto transition-all duration-300 ${
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                >
                  <img src="https://static.wikia.nocookie.net/ep-deo/images/a/a4/MagnifyingGlass.png/revision/latest?cb=20260730091531" className="w-5 h-5 object-contain" referrerPolicy="no-referrer" alt="Search" />
                </button>
